    ...
    <main>
      <div className="flex flex-col items-center justify-center min-h-[91vh] pt-24 w-full">
        ...
        <div className="flex justify-evenly w-full max-w-xs sm:max-w-md lg:max-w-lg my-4 py-2 px-4">
          <button onClick={scrollToAbout} className="bg-rose-400 rounded-full flex-1 mx-2 py-2 text-black text-lg">Know more</button> {/* Step 4: Attach the function to button */}
          <button className="border-white border-2 rounded-full flex-1 mx-2 py-2 text-white" onClick={redirectToBookingPage}>Book a call</button>
        </div>
      </div>
